    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, help_text='URL-safe version of the section name, used in links. Auto-generated if left blank.', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_leader', models.BooleanField(default=False, help_text='Whether the member is a section leader.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nickname', models.CharField(blank=True, help_text="The member's chosen nickname, to be displayed instead of their roster name.", max_length=50, null=True)),
                ('preferred_email', models.EmailField(blank=True, help_text="The member's preferred contact email.", max_length=254, null=True)),
